        ...
        return(
            <div className="container vcenter" style={{height: '80%', width: '80%', margin: '0 auto', position: 'relative'}}>
                ...
                <AwesomeButton type='primary' style={{ height: '70%', width: "40%", 'margin-right': "5%" }}>
                    <h3 style={{ color: '#ffffff', top: '35%', position: 'relative' }}>{this.state.cards[0] != null && this.state.cards[0].term}</h3>
                </AwesomeButton>
                <AwesomeButton type='primary' style={{ height: '70%', width: "40%" }}>
                    <h3 style={{ color: '#ffffff', top: '35%', position: 'relative' }}>{this.state.cards[1] != null && this.state.cards[1].term}</h3>
                </AwesomeButton>
            </div>
        )
    }
